package com.github.cataclysmuprising.springdatajpatutorial.mapper;
...
public final class TodoMapper {
	...
	/**
	 * Transforms the list of {@link Todo} objects given as a method parameter into a list of {@link TodoDTO} objects and returns the created list.
	 *
	 * @param entities
	 * @return
	 */
	public static List<TodoDTO> mapEntitiesIntoDTOs(Iterable<Todo> entities) {
	...
	/**
	 * Transforms the {@link Todo} object given as a method parameter into a {@link TodoDTO} object and returns the created object.
	 *
	 * @param entity
	 * @return
	 */
	 ...
	 * @param source
	 *            The {@code Page<ENTITY>} object.
	 * @return The created {@code Page<DTO>} object.
	 */
	public static Page<TodoDTO> mapEntityPageIntoDTOPage(Pageable pageRequest, Page<Todo> source) {
