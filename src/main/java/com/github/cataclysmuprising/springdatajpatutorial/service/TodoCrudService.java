...
/**
 * This service provides CRUD operations for {@link net.petrikainulainen.springdata.jpa.todo.Todo} objects.
 *
...
public interface TodoCrudService {
	 ...
	 * @throws net.petrikainulainen.springdata.jpa.todo.TodoNotFoundException
	 *             if the deleted todo entry is not found.
	 */
	 ...
	 * 
	 * @param id
	 *            The id of the wanted todo entry.
	 * @return The information of the requested todo entry.
	 * @throws net.petrikainulainen.springdata.jpa.todo.TodoNotFoundException
	 *             if no todo entry is found with the given id.
	 */
	 ...
	 * 
	 * @param updatedTodoEntry
	 *            The new information of an existing todo entry.
